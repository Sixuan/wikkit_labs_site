!function (e, t) {
    ...
    return function (e) {
        ...
        function r(e, t) {
            ...
            t = t || {}, n.defaults = {width: null, height: null, fieldName: "file", quality: .7}, n.file = e;
        ...
        var a = n(1), s = n(4), u = n(5), l = function (e) {
        ...
        r.prototype.init = function () {
            var e = this, t = e.file, n = "string" == typeof t, r = /^data:/.test(t), i = new Image, u = document.createElement("canvas"), l = n ? t : URL.createObjectURL(t);
            ...
            var e = this, t = e.img, r = e.canvas, i = e.defaults, o = e.orientation;
            ...
            var e = this, t = e.resize, r = e.img, i = e.canvas, o = e.ctx, s = e.defaults, u = e.orientation;
            switch (u) {
                case 3:
            ...
            return new a(function (e) {
                l.oldAndroid || l.mQQBrowser || !navigator.userAgent ? n.e(2, function (t) {
                    var n = [t(7)];
                    (function (t) {
                        var n = new t, r = o.getImageData(0, 0, i.width, i.height);
        ...
        (function (t) {
            !function (n) {
                ...
                var d = "function" == typeof t && t || function (e) {
                        setTimeout(e, 1)
        ...
        (function (e, r) {
            ...
            var o = n(3).nextTick, a = Function.prototype.apply, s = Array.prototype.slice, u = {}, l = 0;
        ...
        var r = function () {
            ...
            var e = 0;
            return function () {
                var t = this, n = [], i = Array(21).join("-") + (+new Date * (1e16 * Math.random())).toString(36), o = XMLHttpRequest.prototype.send;
        ...
        (function () {
            ...
            function d(e, t, n, r, i) {
                var o, a, s, u = e.getUint16(n, !i), l = {};
                for (s = 0; u > s; s++)o = n + 12 * s + 2, a = r[e.getUint16(o, !i)], !a && p && console.log("Unknown tag: " + e.getUint16(o, !i)), l[a] = f(e, o, t, n, i);
                return l
            }

            function f(e, t, n, r, i) {
                var o, a, s, u, l, c, d = e.getUint16(t + 2, !i), f = e.getUint32(t + 4, !i), g = e.getUint32(t + 8, !i) + n;
                switch (d) {
                    case 1:
                    case 7:
                    ...
                    case 4:
                        ...
                        return a;
                    case 5:
                        if (1 == f)return l = e.getUint32(g, !i), c = e.getUint32(g + 4, !i), s = new Number(l / c), s.numerator = l, s.denominator = c, s;
                        for (a = [], u = 0; f > u; u++)l = e.getUint32(g + 8 * u, !i), c = e.getUint32(g + 4 + 8 * u, !i), a[u] = new Number(l / c), a[u].numerator = l, a[u].denominator = c;
                        return a;
                    case 9:
