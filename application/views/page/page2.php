            ...
            <div class="row clearfix">
                <div class="col-md-6 column" style="padding-left: 0px;">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-8 column"><div class="demo-landmark-type">
                            <input type="hidden" nam="get_value" id="get_value" value="1">
                            <a href="javascript:void(0);" class="landmark-type" data-type="5p" onclick="get_points(1)">5</a>
                            <a href="javascript:void(0);" class="landmark-type" data-type="25p" onclick="get_points(2)">25</a>
                            <a href="javascript:void(0);" class="landmark-type" data-type="83p" onclick="get_points(3)">83</a>
                          </div>
                            <div class="hearo-my-img">
                                <!-- <canvas id="myCanvas" width="480" height="480" style="">您的浏览器不支持 HTML5 canvas 标签。</canvas> -->
                                <img src="face/1_1.png" alt="" id="scream" style="">
...
<script>
    $(document).ready(function(){
        ...
        $.get("<?php echo site_url('Page/face') ?>?id=",function(data,status){
            /*$('#jsoncode').html(data);*/
            $('#get_value').val(1);
        ...
        for(i=0;i<obj_a.length;i++){
            $(obj_a[i]).click(function(){
                ...
                path = "<?php echo base_url()?>public/face/"+img_value+"_1.png";
                $("#scream").attr('src',path);
                $.get("<?php echo site_url('Page/face') ?>?id="+img_value,function(data,status){
                    /*$('#jsoncode').html(data);*/
                    $('#get_value').val(img_value);
                    $('#jsoncode').html(jsonFormat(data));
                }); 
            })
        }
...
<script>
    function get_points(val){
        var img_value;
        img_value = $('#get_value').val();
        path = "<?php echo base_url()?>public/face/"+img_value+'_'+val+".png";
        $("#scream").attr('src',path);
    }
    <!--二维码-->
